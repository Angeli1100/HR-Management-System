        ...
        <div class="card">
            ...
            <div class="card-footer">
                <div class="btn-group mt-3">
                    <a href="{{ route('backend.employee.generate_link') }}" class="btn btn-info" id="generateLink">Generate Attendance Link</a>
                    <a href="{{ route('backend.employee.deactivate_link') }}" class="btn btn-info" id="deactivateLink">Deactivate Link</a>
                    <a href="{{ URL::to('generate_report') }}" class="btn btn-info" id="generatePDF">Generate Report</a>
                </div>
                @isset($link)
