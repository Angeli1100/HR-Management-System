      ...
      <div class="col-md-2">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Edit Employee's Task</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
...
<div class="form-group">
  ...
  <input type="text" name="employeeName" value="{{$edit->employeeName}}"  class="form-control @error('title') is-invalid @enderror"
